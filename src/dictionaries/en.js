  ...
  pages: {
    ...
    pricing: {
          ...
          tiers: [
            {
              ...
              audience: "For a solo owner or brand-new business",
              turnaround: "3–5 business days",
              includes: [
                "Up to 3 custom pages, mobile-first design",
                "Modern animated hero section (lightweight, no jQuery)",
                "Contact form with spam protection",
                "Core Web Vitals–optimized build + basic SEO",
              ],
            },
            {
              ...
              includes: [
                "Up to 10 unique pages",
                "Headless CMS — edit content without a developer",
                "8 images, 5 custom banner designs",
                "WCAG 2.2 AA accessibility baseline",
              ],
            },
            {
          ...
          tiers: [
            {
              ...
              audience: "A lean, real online store to start selling",
              turnaround: "2–3 weeks",
              includes: [
                "Custom design, up to 50 products",
            ...
            },
            {
              ...
              audience: "Unlimited catalog, dedicated team",
              turnaround: "4–6 weeks",
              mostPopular: true,
              includes: [
                "Unlimited products, unlimited revisions",
                "Dedicated design + development team",
                "Full cart, reviews & product search",
                "Google-optimized sitemap",
              ],
            },
            {
              name: "E-Commerce Prime",
              audience: "A full commerce build, ready to scale",
              turnaround: "6–8 weeks",
              includes: [
                "Unlimited products & categories",
                "Full dedicated team: designer, developer, PM",
                "Complete commerce stack + multi-currency",
                "Free starter brand kit (social covers, brochure, invoice, email signature)",
              ],
            },
          ],
        },
      ...
      techFoundation: {
        ...
        items: [
          "Frontend: React / Next.js with Tailwind CSS — fast, mobile-first by default",
          "Performance: Core Web Vitals–optimized builds, no legacy jQuery sliders or plugins",
          "Accessibility: WCAG 2.2 AA baseline on every site we ship",
          "SEO: automated XML sitemap, schema.org structured data, Search Console + GA4 setup",
          "Security: free SSL/HTTPS, security headers, spam-protected forms",
          "Hosting: edge hosting (Vercel/Cloudflare) with full deployment handled for you",
          "CMS tiers use a modern headless CMS so you can edit content without a developer",
          "Optional AI add-ons at any tier: chat/FAQ widget, AI-assisted copywriting, AI-generated imagery",
        ],
      },
